...
<html>
  ...
  <body>
	...
	<li><a href="#ios" data-toggle="tab">查看全部入住的损坏</a></li>
...
<div id="myTabContent" class="tab-content">
	...
	<table class="table table-bordered"  id="gg" style="width:990px;height:500px"
			url=SerchBreakById
			title="查看损坏账单"
			striped="true"
			pagination="true"
...
$('#dg').datagrid({//显示数据
	...
	onExpandRow: function(index,row){
		...
		ddv.datagrid({
			...
			onResize:function(){
				$('#gg').datagrid('fixDetailRowHeight',index);//明细的显示
			},
			onLoadSuccess:function(){
				setTimeout(function(){
					$('#gg').datagrid('fixDetailRowHeight',index);
				},0);
			}
		});
		$('#gg').datagrid('fixDetailRowHeight',index);
