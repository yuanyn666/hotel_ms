...
<html>
 ...
 <div class="modal-header" style="width: 870px;height: 20px; ">
 	<h4 class="modal-title" id="myModalLabel" style="margin-bottom: -11px;">下架商品信息
 	</h4>
 	<a href="findAllP" class="btn btn-primary" style="float: right; width: 100px;margin-top: -20px;">返回商品信息</a>
 	<form action="findNameT" method="post" style="width: 350px; float: right;margin-top: -20px;"> 
    ...
    <td>
    <a href="updateStateT?productId=${s.productId}" class="btn btn-primary" >上架</a>
	</td>
    </tr>
    </c:forEach>
