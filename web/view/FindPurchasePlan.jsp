...
<html>
  ...
  <form method="post" class="form-horizontal" id="aa">
  	<div style="position: relative; margin-left: 80px;margin-top: 10px">
  		...
  		<span style="margin-left: 20px;"> 状态查询：</span><select id="start" style="width: 155px;">
  		...
  		<span style="color: red;margin-left: 20px;">②双击订单信息可查看订单详情进行采购</span><br/>
  		</span> -->
  	</div>
  	</form>
	...
	<table id="dg" style="width:600px;height:300px"
			url=FindPurchasePlan
			pagination="true" sortName="saleid" sortOrder="desc"
			title="查看采购计划订单"
			singleSelect="true" fitColumns="true">
		<thead>
			<tr>
				<th field="planId" align="center" width="166">计划单号</th>
				<th field="planDate" widths="166" align="center">申请时间</th>
				<th field="names" widths="166" align="center">申请人</th>
				<th field="mark" widths="166" align="center">说明</th>
  ...
  parent.location.reload();
	...
	onExpandRow: function(index,row){
		...
		ddv.datagrid({
			url:'FindPlanDetail?id='+row.planId,
			fitColumns:true,
			singleSelect:true,
			rownumbers:true,
			loadMsg:'',
