...
"<td><input type='text'  name='productSum' value="+d+"></td>"+
"<td><input type='text'  name='buyPrice'  readonly='readonly' value="+r.buyPrice+"></td>"+
...
<style>
table input{border: 0px; width: 80px;}
html { overflow:hidden; }
</style>
  <body>
     <form action="" method="post" id="from2">
     <div style="margin-top: 30px;">
     <span style="margin-left: 10px;" >计划单号: <input  type="text" value="${planId}" name="planId"  readonly="readonly"  style="width: 160px; background-color: white;"></span>
   <span style="margin-left: 10px;" >生成日期:<input type="text"  style="width:160px; background-color: white;" value="${planDate}" name="planDate" readonly="readonly" ></span>
   ...
   <div align="center"><span style="margin-left: 10px;">选择商品: <input width="170" type="text" id="pro"></span> 
   <span style="margin-left: 10px;">商品数量:<input type="text" onkeyup="if(/\D/.test(this.value)){alert('只能输入数字');this.value='';}" id="sum" maxlength="5" style="border-style: none none solid; border-color: -moz-use-text-color -moz-use-text-color red; border-width: 0px 0px 1px; width: 80px; background-color: white;"></span> 
   ...
   <table id="table" class="table" height="140px;" >
   	<tr id="tabletr"><td>商品编号</td><td>商品名称</td><td>商品数量</td><td>商品单价</td></tr>
   </table>
   </div>
<div class="modal-footer" style="width: 630px;height: 30px;text-align: center;">
<input type="button" value="提交计划" id="sub" class="btn btn-primary" style="width: 100px;height: 30px; float: right;"/>
</div>
   </form>
 <script type="text/javascript">
 $("#pro").combogrid({
...
if(a=="")
{
	...
	document.forms.from2.action="adPurchasePlan";
