...
<li><a href="javascript:" class="three-d">财务管理 <span class="three-d-box"><span class="front">财务管理</span><span class="back">财务管理</span></span> </a>
<ul class="clearfix unstyled drop-menu" id="p2">

</ul>
</li>
<li><a href="javascript:" class="three-d"> 客房中心 <span class="three-d-box"><span class="front">客房中心</span><span class="back">客房中心</span></span> </a>
<ul class="clearfix unstyled drop-menu" id="p3">

</ul>
</li>
<li><a href="javascript:" class="three-d"> 商品管理 <span class="three-d-box"><span class="front">商品管理 </span><span class="back">商品管理 </span></span> </a>
<ul class="clearfix unstyled drop-menu" id="p4">

</ul></li>
<li><a href="javascript:" class="three-d"> 库存管理 <span class="three-d-box"><span class="front">库存管理 </span><span class="back">库存管理 </span></span> </a>
<ul class="clearfix unstyled drop-menu" id="p5">

</ul></li>
<li><a href="javascript:" class="three-d">帮助中心 <span class="three-d-box"><span class="front">帮助中心 </span><span class="back">帮助中心 </span></span> </a>
...
<c:when test="${myUsers.usersRoleId==4}">
<iframe src="<%=basePath%>findAllDepotProduct" height="800px" width="100%" frameborder="0" name="main" title="主页面">
</iframe> 
</c:when>
